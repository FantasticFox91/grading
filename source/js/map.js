...
const BASIC_MAP_SCALING = 16;
const MAIN_PIN_SIZE = 38;
mapContainer.innerHTML = "";
let map = L.map("map").setView([BASIC_LAT, BASIC_LNG], 17);
...
const mainPinMarker = L.icon({
  ...
  iconSize: [MAIN_PIN_SIZE, 50],
  iconAnchor: [MAIN_PIN_SIZE/2, 50],
});
